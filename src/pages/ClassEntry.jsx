        ...
        <div className="p-6 text-center space-y-4">
          ...
          <div className="pt-2 space-y-3">
            <Link 
              ...
              className="w-full bg-orange-500 text-white py-3 rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-orange-600 transition-all shadow-lg flex items-center justify-center gap-2"
            >
